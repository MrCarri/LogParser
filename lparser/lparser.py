...
import sys
import lparser_reader as reader
import  lparser_jobmanager as job_manager
import lparser_writer as writer
import argparse
import os
...
def main():
    ...
    def parse_main_args():
        ...
        parser.add_argument('--extraf',"-ex", required = True, help="Generate Extra information file if true")
